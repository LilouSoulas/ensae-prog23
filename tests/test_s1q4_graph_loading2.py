...
class Test_GraphLoading(unittest.TestCase):
    ...
    def test_network1(self):
        ...
        self.assertEqual(g.graph[5][0][2])  #la fonction graph_from_file a été modifiée afin de faire apparaître la distance par défaut
...
## FAILED, est ce que Q4 a ete faite?